                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3">
                    <div class="card">
                        ...
                        <div class="body">     
                            ...
                            @endif                 
                            <form id="form_validation" method="POST" action="/ship_cost/update/{{ $ship_cost->id }}" name="edit">
                                ...
                                <div class="row clearfix"> 
                                <div class="col-md-12">
                                    <h2 class="card-inside-title">Ship Cost ( Only affects new orders. )</h2>
                                    <div class="form-line">
                                        <input type="number"  class="form-control" name="item" placeholder="Input category name." value="{{ $ship_cost->value }}" required>
                                    </div>
                                </div>         
                                </div> 
                                <div class="row clearfix">
                                ...
                                <button class="btn btn-success waves-effect" type="submit">UPDATE</button>
                                 <a href="/ship_cost/back" class="btn btn-danger waves-effect pull-right" type="submit">BACK</a>
                                </div> 
                                </div>
                            </form>
                        </div>
