                    ...
                    <div class="card">
                        ...
                        <div class="body">
                              @if(count($errors) > 0)
                                ...
                                @endforeach
                            @endif                          
                            <form id="form_validation" method="POST" action="/category/{{ $category->id }}" name="edit">
                            ...
                            {{ method_field ('PUT') }}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="category_name" placeholder="Input category name." value="{{ $category->category_name }}" required>
                                    </div>
                                </div>         
                                </div> 
                                <div class="row clearfix">                            
...
@section('side-menu')
          <div class="menu">
            ...
            <script type="text/javascript">
                document.forms['edit'].elements['category_status'].value="{{ $category->category_status }}";
            </script>
@endsection
