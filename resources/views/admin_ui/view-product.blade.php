                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">    
                        ...
                        <div class="body">
                            <ol class="breadcrumb breadcrumb-col-pink">
                                <li><a href=""><i class="material-icons">view_list</i> Products</a></li> 
                                <li>View Products</li>                               
                            </ol>                        
                        </div>                   
                </div>
...
swal("View - product Published", " ", "success");
        ...
        closeOnConfirm: true,
         ...
         var id = $id;
             $.ajax({
                    ...
                    url: 'product/'+ id,
                    success: function(data) {
                        swal("Deleted!", "View - product has been deleted.", "success");
                        table.ajax.reload();
                        }
                });
    });
