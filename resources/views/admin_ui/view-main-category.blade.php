                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">    
                        ...
                        <div class="body">
                            <ol class="breadcrumb breadcrumb-col-pink">
                                ...
                                <li>Main Category</li>
                                <li class="active">View Main Categories</li>                               
                            </ol>                        
                        </div>                   
                </div>
            </div>
...
<script>
   var table = $('#main').DataTable({
        ...
        columns: [
            ...
            { data: 'status', name: 'category_status'},
...
swal("Category Unpublished", " ", "success");
        var id = $id;
 $.ajax({
        type: 'post',
        url: 'category/unpublished/'+ id,
...
swal("Category Published", " ", "success");
