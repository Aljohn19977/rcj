                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">    
                        ...
                        <div class="body">
                            <ol class="breadcrumb breadcrumb-col-pink">
                                ...
                                <li>Main Category</li>
                                <li class="active">Add Main Categories</li>                             
                            </ol>                        
                        </div>                   
                </div>
            </div>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <h2>CUSTOMER ACTIVE ACOUNTS STATISTICS</h2>
                        ...
                        <div class="body">
                            <div id="chartdiv2" style="height: 293px;"></div> 
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <div class="card">
                        ...
                        <div class="body">
                            <div id="chartdiv3" style="height: 312px;"></div> 
                        </div>
                    </div>
                </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <h2>CUSTOMER INQUIRY STATISTICS</h2>
...
function generateChartData2() {
    var chartData2 = [];
    var sales = {!! json_encode($customer_inq->toArray()) !!};
    $.each(sales, function(key, item) {
        var newDate = item.date;
        var visits = item.count;
...
var chartData = [
    @php
    $category_each = DB::table('categories')->whereNull('deleted_at')->select('category_name')->get();

    @endphp
    @foreach($category_each as $res)

    @php $count_category_each = DB::table('products')->whereNull('deleted_at')->where('category_name','=',$res->category_name)->count(); @endphp
    ...
    "data": [
    @php $subcategory_each = DB::table('products')->whereNull('deleted_at')->select('subcategory_name')->where('category_name','=',$res->category_name)->distinct()->get(); @endphp
    @foreach($subcategory_each as $res2)
    @php $count_subcategory_each = DB::table('products')->whereNull('deleted_at')->where('subcategory_name','=',$res2->subcategory_name)->count(); @endphp
