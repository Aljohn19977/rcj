...
function returns($id){
 ...
 swal({
        title: "Are you sure you want to return to Active Orders Table?",
        type: "warning",
         ...
         var id = $id;
             $.ajax({
                    ...
                    success: function(data) {
                        if(data['errors']==1){
                        swal("Failed!", "Unable to returned product to Active Orders Table. ", "warning");
                        }
                        else if(data['errors']==2){
                        swal("Returned!", "Order has been returned to Active Orders Table.", "success");
                        }
                        table.ajax.reload();
                        }
                });
 ...
 swal({
        ...
        closeOnConfirm: true,
         ...
         var id = $id;
             $.ajax({
                    type: 'delete',
                    url: '/canceled_orders/'+ id ,
                    success: function(data) {
                        if(data['error']==1){
                        swal("Failed!", "Unable to remove currently on refund process. ", "warning");
                        }else{
                        swal("Deleted!", "Cancel order has been removed.", "success");   
                        }
                        table.ajax.reload();
                        }
                });
