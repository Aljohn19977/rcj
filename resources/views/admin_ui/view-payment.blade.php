                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">    
                        ...
                        <div class="body">
                            <ol class="breadcrumb breadcrumb-col-pink">
                                <li><a href=""><i class="material-icons">attach_money</i> Payments and Refunds</a></li> 
                                <li>Payments</li>
                                <li class="active">Active Payments Table</li>
                            </ol>                        
                        </div>                   
                </div>
            </div>
         ...
         var id = $id;
             $.ajax({
                    ...
                    success: function(data) {
                        if(data['error']==1){
                        swal("Removed!", "Payment has been removed. ", "success");
                        }else if(data['error']==2){
                        swal("Failed!", "Unable to remove Payment it has Active Orders or Payment Refunds. ", "warning");    
                        }
                        table.ajax.reload();
                        }
                });
