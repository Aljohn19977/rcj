                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            @if(count($errors) > 0)
                                ...
                                @endforeach
                            @endif
                            <form id="form_validation" method="POST" name="add" action="/category">
                                {{ csrf_field() }}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="category_name" placeholder="Input category name." value="{{ Request::old('category_name') }}" required>
                                    </div>
                                </div>         
                                </div> 
                                <div class="row clearfix">                            
                                ...
                                <h2 class="card-inside-title">Publication Status</h2>
                                    <select class="form-control show-tick" name="category_status" required>    
                                ...
                                <a href="/category" class="btn btn-danger waves-effect pull-right" type="submit">CANCEL</a>
                                </div> 
                                </div>
                            </form>
                        </div>
...
@section('side-menu')
        ...
        <script type="text/javascript">
            document.forms['add'].elements['category_status'].value="{{ Request::old('category_status') }}";
        </script>   
@endsection
