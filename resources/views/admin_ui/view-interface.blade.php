                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3">
                    <div class="card">
                        ...
                        <div class="body">     
                            ...
                            @endif                 
                            <form id="form_validation" method="POST" action="/content_interface/update/{{ $email->id }}" name="edit">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-line">
                                        <input type="email" class="form-control" name="item" placeholder="Input category name." value="{{ $email->value }}" required>
                                    </div>
                                </div>         
                                </div> 
                                <div class="row clearfix">
                                <div class="col-md-12 col-sm-12">                         
                                <button class="btn btn-success waves-effect pull-right" type="submit">UPDATE</button>
                                </div> 
                                </div>
                            </form>
                            <form id="form_validation" method="POST" action="/content_interface/update/{{ $landline->id }}" name="edit">
                                ...
                                <div class="row clearfix"> 
                                <div class="col-md-12">
                                    <h2 class="card-inside-title">Landline.</h2>
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="item" placeholder="Input category name." value="{{ $landline->value }}" required>
                                    </div>
                                </div>         
                                </div> 
                                <div class="row clearfix">
                            ...
                            <form id="form_validation" method="POST" action="/content_interface/update/{{ $facebook->id }}" name="edit">
                                ...
                                <div class="row clearfix"> 
                                <div class="col-md-12">
                                    <h2 class="card-inside-title">Facebook Account URL.</h2>
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="item" placeholder="Input category name." value="{{ $facebook->value }}" required>
                                    </div>
                                </div>         
                                </div> 
                                <div class="row clearfix">
                            ...
                            <form id="form_validation" method="POST" action="/content_interface/update/{{ $twitter->id }}" name="edit">
                                ...
                                <div class="row clearfix"> 
                                <div class="col-md-12">
                                    <h2 class="card-inside-title">Twitter Account URL.</h2>
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="item" placeholder="Input category name." value="{{ $twitter->value }}" required>
                                    </div>
                                </div>         
                                </div> 
                                <div class="row clearfix">
                                ...
                                <div class="col-md-12 col-sm-12">
                                <center>
                                 <a href="/content_interface/back" class="btn btn-danger waves-effects" type="submit">BACK</a>
                                </center>
                                </div> 
                                </div>
                        </div>
