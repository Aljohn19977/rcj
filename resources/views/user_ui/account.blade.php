      ...
      <div class="container">
          <div class="col-md-4">
                              @if(count($errors) > 0)
                                ...
                                <div class="alert alert-warning" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>{{$error}}</div>
                                @endforeach
                            @endif    
            <div class="panel panel-default">
              <div class="panel-heading" style="background-color: #953255; color:#fff;"><h4>My Account</h4></div>
                  ...
                  <div class="col-md-10 col-md-offset-1">
                        ...
                        {{ csrf_field() }}
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="names" name="name" value="{{ $user->name }}" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <center>
                            <a onclick="edit" id="edit" class="btn btn-default" style="background: #953255;
                              border: medium none;
                              border-radius: 0;
                              color: #FFFFFF;
                              font-family: 'Roboto', sans-serif;
                              padding: 6px 25px;
                              margin-top:20px;">Update</a>   
                            <button class="btn btn-default" id="save" type="submit" style="background: #953255;
                              border: medium none;
                              border-radius: 0;
                              color: #FFFFFF;
                              font-family: 'Roboto', sans-serif;
                            ...
                            <a class="btn btn-default" id="cancel" type="cancel" style="background: #953255;
                              border: medium none;
                              border-radius: 0;
                              color: #FFFFFF;
                              font-family: 'Roboto', sans-serif;
          ...
          <div class="col-md-8">
                @if(Session::has('message'))
                        <div class="alert alert-success" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>Thank You!</strong> {{ Session::get('message') }}</div>
                    @endif         
            <div class="panel panel-default">
              <div class="panel-heading" style="background-color: #953255; color:#fff;"><h4>Orders</h4></div>
               <div class="panel-body">  
...
<!--                   <table class="table table-condensed total-result">
                  ...
                  <tr class="shipping-cost">
                    <td>Shipping Cost</td>
                    <td>&#8369; {{ $shipping_cost = 150 }}</td>                   
                  </tr>
                  <tr>
                    <td>Total</td>
                    <td><span>&#8369; {{ Cart::subtotal() + $shipping_cost }}</span></td>
                  </tr>
                </table> -->
                </div>
            </div>
          ...
          <div class="col-md-4"></div>
            <div class="col-md-8">
            <div class="panel panel-default">
              <div class="panel-heading" style="background-color: #953255; color:#fff;"><h4>Refunds</h4></div>
               <div class="panel-body">  
                   <div class="table-responsive">
                      <table id="main2" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        <thead>
                            <tr>
                                <th>Order ID</th>
                                <th>Payment ID</th>  
...
<!--                   <table class="table table-condensed total-result" id="mema">
                  <tr>
                  <th>Payment Term</th>
                  <th>Amount</th>
                  </tr>
...
var tables = $('#main2').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('api.userrefund') }}",
        columns: [
...
function deletes_refund($id){
 
         var id = $id;
             $.ajax({
                    type: 'post',
                    url: '/account/refund/'+ id ,
                    success: function(data) {
                        alert("Removed! Refund Payment has been removed.");   
                        tables.ajax.reload();
                        }
                });
};
...
//              $.ajax({
//                     type: 'post',
//                     url: '/canceled_orders/return/'+ id,
//                     success: function(data) {
//                         if(data['errors']==1){
//                         alert("Failed! Unable to returned product to Active Orders Table.");
//                         }
//                         else if(data['errors']==2){
//                         alert("Returned! Order has been returned to Active Orders Table.");
//                         }
//                         table.ajax.reload();
//                         }
//     });
 ...
 $(document).ready(function(){
  ...
  $("#cancel").hide();
    $(document).on('click','#edit',function(event){
        $("#names").removeAttr("disabled", "disabled");
        $("#edit").hide();
         $("#save").show();
         $("#cancel").show();
