                    ...
                    <div class="card">
                        ...
                        <div class="body">
                              @if(count($errors) > 0)
                                ...
                                @endforeach
                            @endif                          
                            <form role="form" id="form_validation" method="POST" action="/account/delivery/{{ $admin->id }}" name="edit">
                            ...
                            {{ method_field ('PUT') }}
                                ...
                                <button class="btn btn-success waves-effect" type="submit">UPDATE</button>
                                 <a href="/account/delivery" class="btn btn-danger waves-effect pull-right" type="submit">BACK</a>
                                </div> 
                                </div>
                            </form>
                        </div>
