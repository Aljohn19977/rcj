                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table id="main" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr>
                                            <th width="100">Sub - category ID</th>
...
<script>
  var table = $('#main').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('api.subcategory') }}",
        columns: [
            { data: 'id', name: 'id' },
            { data: 'subcategory_name', name: 'subcategory_name' },
            { data: 'category', name: 'category_name' },
            { data: 'status', name: 'subcategory_status'},
...
swal("Sub - Category Unpublished", " ", "success");
        var id = $id;
 $.ajax({
        type: 'post',
        url: 'sub-category/unpublished/'+ id,
...
swal("Sub - Category Published", " ", "success");

        var id = $id;
 $.ajax({
        type: 'post',
        url: 'sub-category/published/'+ id,
        success: function(data) {
            table.ajax.reload();
            }
    });
