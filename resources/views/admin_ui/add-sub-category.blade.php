                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            @if(count($errors) > 0)
                                ...
                                @endforeach
                            @endif
                            <form id="form_validation" method="POST" name="add" action="/sub-category">
                                {{ csrf_field() }}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="subcategory_name" placeholder="Input category name." value="{{ Request::old('subcategory_name') }}" required>
                                    </div>
                                </div>         
                                </div> 
                                <div class="row clearfix">                            
                                    ...
                                    <h2 class="card-inside-title">Main Category</h2>
                                        ...
                                        <input type="hidden" id="category_name" name="category_name" value="{{ Request::old('category_name') }}" readonly="readonly">
                                    </div>   
                                </div>
                                <div class="row clearfix">                            
                                    <div class="col-md-12">
...
@section('side-menu')
          <div class="menu">
             ...
             document.forms['add'].elements['subcategory_status'].value="{{ Request::old('subcategory_status') }}";
             document.forms['add'].elements['category_id'].value="{{ Request::old('category_id') }}";
             </script>  
@endsection
