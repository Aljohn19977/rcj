...
class AccountDeliveryController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        return view('admin_ui.view-delivery-account',compact('admin'));
    }
    ...
    {   
        ...
        $admin = Admin::where('id','=',2)->first();
        return view('admin_ui.edit-delivery-account',compact('admin'));
    }
